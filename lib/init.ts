...
declare("InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANIPConnection.*.Uptime", {path: hourly, value: hourly});
...
export async function seed(options: Record<string, boolean>): Promise<void> {
  ...
  if (options.device) {
    resources["config"] = (resources["config"] || []).concat([
      ...
      {_id: "ui.device.0.parameters.0.label", value: "'Last inform'"},
      {_id: "ui.device.0.parameters.0.components.0.type", value: "'parameter'"},
      {_id: "ui.device.0.parameters.0.components.1.chart", value: "'online'" },
      {_id: "ui.device.0.parameters.0.components.1.type", value: "'overview-dot'"},
      {_id: "ui.device.0.parameters.0.components.2.type", value: "'summon-button'"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.0", value: "InternetGatewayDevice.DeviceInfo.HardwareVersion"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.1", value: "InternetGatewayDevice.DeviceInfo.SoftwareVersion"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.2", value: "InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANIPConnection.*.MACAddress"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.3", value: "InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANIPConnection.*.ExternalIPAddress"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.4", value: "InternetGatewayDevice.LANDevice.*.WLANConfiguration.*.SSID"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.5", value: "InternetGatewayDevice.LANDevice.*.WLANConfiguration.*.KeyPassphrase"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.6", value: "InternetGatewayDevice.LANDevice.*.Hosts.Host.*.HostName"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.7", value: "InternetGatewayDevice.LANDevice.*.Hosts.Host.*.IPAddress"},
      {_id: "ui.device.0.parameters.0.components.2.parameters.8", value: "InternetGatewayDevice.LANDevice.*.Hosts.Host.*.MACAddress"},
      {_id: "ui.device.0.parameters.0.parameter", value: "DATE_STRING(Events.Inform)"},
      {_id: "ui.device.0.parameters.1.label", value: "'Serial number'" },
      {_id: "ui.device.0.parameters.1.parameter", value: "DeviceID.SerialNumber"},
      {_id: "ui.device.0.parameters.2.label", value: "'Product class'" },
      {_id: "ui.device.0.parameters.2.parameter", value: "DeviceID.ProductClass"},
      {_id: "ui.device.0.parameters.3.label", value: "'OUI'" },
      {_id: "ui.device.0.parameters.3.parameter", value: "DeviceID.OUI"},
      {_id: "ui.device.0.parameters.4.label", value: "'Manufacturer'" },
      {_id: "ui.device.0.parameters.4.parameter", value: "DeviceID.Manufacturer"},
      {_id: "ui.device.0.parameters.5.label", value: "'Hardware version'" },
      {_id: "ui.device.0.parameters.5.parameter", value: "InternetGatewayDevice.DeviceInfo.HardwareVersion"},
      {_id: "ui.device.0.parameters.6.label", value: "'Software version'" },
      {_id: "ui.device.0.parameters.6.parameter", value: "InternetGatewayDevice.DeviceInfo.SoftwareVersion"},
      {_id: "ui.device.0.parameters.7.label", value: "'MAC'" },
      {_id: "ui.device.0.parameters.7.parameter", value: "InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANIPConnection.1.MACAddress"},
      {_id: "ui.device.0.parameters.8.label", value: "'IP'" },
      {_id: "ui.device.0.parameters.8.parameter", value: "InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANIPConnection.1.ExternalIPAddress"},
      {_id: "ui.device.0.parameters.9.label", value: "'WLAN SSID'" },
      {_id: "ui.device.0.parameters.9.parameter", value: "InternetGatewayDevice.LANDevice.1.WLANConfiguration.1.SSID"},
      {_id: "ui.device.0.parameters.10.label", value: "'WLAN passphrase'" },
      {_id: "ui.device.0.parameters.10.parameter", value: "InternetGatewayDevice.LANDevice.1.WLANConfiguration.1.KeyPassphrase"},

      {_id: "ui.device.1.type", value: "'device-info'"},

      {_id: "ui.device.2.type", value: "'parameter-table'"},
      {_id: "ui.device.2.label", value: "'LAN Hosts'"},
      {_id: "ui.device.2.parameter", value: "InternetGatewayDevice.LANDevice.1.Hosts.Host"},
      {_id: "ui.device.2.childParameters.0.label", value: "'Host Name'"},
      {_id: "ui.device.2.childParameters.0.parameter", value: "HostName"},
      {_id: "ui.device.2.childParameters.1.label", value: "'IP Address'"},
      {_id: "ui.device.2.childParameters.1.parameter", value: "IPAddress"},
      {_id: "ui.device.2.childParameters.2.label", value: "'MAC Address'"},
      {_id: "ui.device.2.childParameters.2.parameter", value: "MACAddress"},
