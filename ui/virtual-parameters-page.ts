...
export const component: ClosureComponent = (): Component => {
    return {
        view: (vnode) => {
            document.title = 'Pro ACS: Virtual Parameters';
                ...
                attrs['actionsCallback'] = (selected: Set<string>): Children => {
                    return [
                        ...
                        m(
                            ...
                            {
                                title   : 'Delete selected Virtual Parameter(s)',
                                ...
                                onclick : (e) => {
                                    ...
                                    Promise
                                        .all(Array.from(selected)
                                                 .map((id) => store.deleteResource('virtualParameters', id)))
                                        .then((res) => {
            ...
            return [
                m('.pagetitle', m('h1', 'Listing Virtual Parameters')),
