import m, { Attributes, Children, ClosureComponent, CommonAttributes, ComponentTypes, Static, Vnode } from 'mithril';
...
interface MC extends Static {
    context: {
        (ctx: Attributes, selector: string, ...children: Children[]): Vnode<any, any>;
        (ctx: Attributes, selector: string, attributes: Attributes, ...children: Children[]): Vnode<any, any>;
        <Attrs, State>(
            ctx: Attributes,
